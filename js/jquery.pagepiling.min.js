...
$(function () {
    $('#pagepiling').pagepiling({
        ...
        sectionsColor: ['#edd5b9', '#B9E2ED', '#EDB9BF', '#B9EDD6', '#EDB9E1', '#BEEDB9', '#D7B9ED', '#E0EDB9'],
        ...
        afterLoad: function (anchorLink, index) {
            const newsDt = document.querySelectorAll('#news dt');
            const conceptL = document.querySelector('#concept .scrollLeft');
            const conceptR = document.querySelector('#concept .scrollRight');
            const beansL = document.querySelector('#beans .scrollLeft');
            const beansR = document.querySelector('#beans .scrollRight');
            const shopify = document.querySelectorAll('#shopify .scrollUp');
            const shopify2 = document.querySelectorAll('#shopify2 .scrollUp');

            // newsアニメーション
            if (anchorLink == 'page2') {
                newsDt.forEach((el) => {
                    el.classList.add('fadein-news');
                });
            }
            // concept beans アニメーション
            if (anchorLink == 'page3') {
                conceptL.classList.add('on');
                conceptR.classList.add('on');

            }
            if (anchorLink == 'page4') {
                beansL.classList.add('on');
                beansR.classList.add('on');
            }
            // shopify アニメーション
            if (anchorLink == 'page5') {
                shopify.forEach((el) => {
